...
const staticDefinitions = [
    ...
    },
    {
        ...
        subtitle: 'LifeSync and GitHub connection settings',
        keywords: ['integrations lifesync connections apps profile'],
        badge: 'Page',
    ...
    },
    {
        ...
        section: 'Integrations',
        label: 'Open GitHub',
        subtitle: 'Repositories, commits, and open issues',
        keywords: ['github repos commits issues dashboard'],
        badge: 'Page',
        run: buildNavigationAction('/dashboard/github'),
    },
    {
