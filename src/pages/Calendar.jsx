...
export default function Calendar() {
    ...
    return (
        <div className="space-y-4 sm:space-y-6 max-w-7xl mx-auto">
            ...
            <div className="px-3.5 py-2.5 sm:px-4 sm:py-3 bg-[var(--color-surface)] border border-[var(--mx-color-d2d2d7)]/40 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
                ...
                {calendarConnected ? (
                    ...
                    <button
                        ...
                        className="px-3.5 py-2 bg-indigo-500 hover:bg-indigo-600 text-white font-bold rounded-xl text-[12px] transition-all active:scale-95 disabled:opacity-60"
                    >
            ...
            {gCalError && (
                <div className="px-3.5 py-2.5 bg-red-50 border border-red-200 rounded-xl text-[12px] text-red-700 flex items-center justify-between gap-2">
