...
export function TVMangaDNASection({ focusPos, onItemSelect, enabled, filterOpen, onRegisterFilter, onFocusedItemChange, onGridMetaChange, page, onPageChange }) {
    ...
    const detailItems = useMemo(() => items.map(buildMangaDNADetailItem), [items])
