            ...
            <div ref={iframeContainerRef} className="relative min-h-0 flex-1 bg-black">
                ...
                {stream?.resolving && (
                    <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-4">
                        <div className="relative">
                            <div className="h-14 w-14 animate-spin rounded-full border-2 border-[var(--mx-color-c6ff00)]/20 border-t-[var(--mx-color-c6ff00)]" />
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="h-5 w-5 animate-pulse rounded-full bg-[var(--mx-color-c6ff00)]/10" />
                            </div>
                        </div>
                ...
                {toast && (
                    <div className="pointer-events-none absolute left-1/2 top-8 z-50 -translate-x-1/2">
                        <div className="flex items-center gap-2 rounded-2xl border border-[var(--mx-color-c6ff00)]/30 bg-black/85 px-5 py-2.5 shadow-2xl backdrop-blur-xl">
                ...
                {settingsOpen && (
                    ...
                    >
                        ...
                        >
                            {/* Accent line */}
                            <div className="pointer-events-none absolute inset-x-0 top-0 h-px rounded-t-3xl bg-linear-to-r from-transparent via-[var(--mx-color-c6ff00)]/60 to-transparent" />

                            {/* Header */}
                            <div className="mb-3 flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <div className="flex h-7 w-7 items-center justify-center rounded-xl bg-[var(--mx-color-c6ff00)]/12">
                                        ...
                                        {['sub', 'dub'].map(opt => (
                                            <button
                                                ...
                                                className={`flex-1 rounded-xl border py-2 text-[12px] font-black uppercase tracking-widest transition-all ${
                                                    audioType === opt
                                                        ? 'border-[var(--mx-color-c6ff00)]/50 bg-[var(--mx-color-c6ff00)]/14 text-(--mx-color-c6ff00) shadow-[0_0_12px_rgba(198,255,0,0.15)]'
                                    ...
                                    <div className="flex flex-wrap gap-1.5">
                                        <button
                                            ...
                                            className={`rounded-xl border px-3 py-1.5 text-[11px] font-black uppercase tracking-wide transition-all ${
                                                !qualityUrl
                                                    ? 'border-[var(--mx-color-c6ff00)]/50 bg-[var(--mx-color-c6ff00)]/14 text-(--mx-color-c6ff00)'
                                                    : 'border-white/10 bg-white/4 text-white/55 hover:border-white/20 hover:text-white/80'
                                            }`}
                                        >
                                            Auto
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className={`flex items-center gap-1.5 rounded-xl border px-3 py-1.5 text-[11px] font-semibold transition-all ${
                            settingsOpen
                                ? 'border-[var(--mx-color-c6ff00)]/40 bg-[var(--mx-color-c6ff00)]/10 text-(--mx-color-c6ff00)'
...
function SettingsSection({ focused, icon, label, hint, children }) {
    return (
        <div className={`rounded-2xl border p-3.5 transition-all ${
            focused
                ? 'border-[var(--mx-color-c6ff00)]/25 bg-white/4'
