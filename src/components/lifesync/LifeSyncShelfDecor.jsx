...
export function SeriesCompleteBadge({ className = '' }) {
    return (
        <div
            ...
            aria-hidden
        >
            <div className="flex items-center gap-1.5 rounded-full border border-emerald-800/25 bg-gradient-to-r from-emerald-50 via-white to-teal-50 px-3 py-1.5 shadow-[0_4px_16px_-4px_rgba(6,95,70,0.28)] ring-[3px] ring-white">
...
export function NewChapterSpotlightBanner() {
    return (
        <div className="pointer-events-none absolute inset-x-0 top-0 z-20 overflow-hidden rounded-t-2xl" aria-hidden>
            <MotionDiv
                className="flex items-center gap-2 border-b border-lime-500/35 bg-gradient-to-r from-[#f7ffce] via-[#d9f99d] to-[#fef08a] px-3 py-2 sm:px-3.5 sm:py-2.5"
            ...
            >
                <span className="relative flex h-2 w-2 shrink-0">
                    ...
                    <span className="relative inline-flex h-2 w-2 rounded-full bg-amber-600 ring-2 ring-white/90" />
                </span>
