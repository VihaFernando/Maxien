    ...
    return (
        <AnimatePresence>
            {visible && (
                ...
                >
                    <div className="flex items-center gap-3 rounded-2xl border border-[var(--color-border-strong)]/20 bg-[var(--color-surface)]/90 px-4 py-3 shadow-xl backdrop-blur-xl">
                        {/* Controller icon */}
                        <svg className="h-5 w-5 shrink-0 text-[var(--mx-color-1d1d1f)]/60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" aria-hidden>
                        ...
                        <span className="text-[12px] font-semibold text-[var(--mx-color-1d1d1f)]/70">
                            Press
                        </span>

                        {/* START button chip */}
                        <span className="inline-flex items-center rounded-lg bg-[var(--mx-color-1d1d1f)] px-2.5 py-1 text-[10px] font-black uppercase tracking-wider text-[var(--color-surface)] shadow-sm">
                            START
                        </span>
                        ...
                        {/* Lime dot */}
                        <div className="h-2 w-2 rounded-full bg-[var(--mx-color-c6ff00)] shadow-[0_0_6px_rgba(198,255,0,0.7)]" />
                    </div>
                </M.div>
            )}
        </AnimatePresence>
